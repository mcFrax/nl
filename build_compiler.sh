...
gcc -std=c99 -O0 -lm -o bin/mk_cache.exe mk_cache.c bin/native_lib_c/*.c bin/nianio_lang_c/*.c -Ibin/native_lib_c -Ibin/nianio_lang_c
./bin/mk_cache.exe tmp/nianio_lang --strict --o tmp/a --c
gcc -std=c99 -O0 -lm -ggdb -o a.exe tmp/a/*.c native_lib_c/*.c mk_cache.c -Itmp/a -Inative_lib_c
./a.exe tmp/nianio_lang --o tmp/b --c
gcc -std=c99 -O0 -lm -ggdb -o b.exe tmp/b/*.c native_lib_c/*.c mk_cache.c -Itmp/b -Inative_lib_c
