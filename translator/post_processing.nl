...
def post_processing::const_reg_val_t() {
	return ptd::arr(ptd::rec({regs => ptd::arr(@post_processing::reg_val_const), was => ptd::sim()}));
}
...
def post_processing::init(mat_fun_def : ptd::hash(ptd::sim()), o : @post_processing::optimization_t) : 
	@post_processing::state_t {
...
def set_const_commands_in_modules(ref state : @post_processing::state_t, changed_functions : ptd::hash(ptd::sim()), ref 
	new_modules_results : ptd::hash(@nlasm::result_t), const_com : @post_processing::math_funs_t, math_fs : 
	@post_processing::math_funs_t) {
...
def evaluate_const_in_modules(ref state : @post_processing::state_t, changed_functions : ptd::hash(ptd::sim()), ref 
	new_modules_results : ptd::hash(@nlasm::result_t), math_fs : @post_processing::math_funs_t) {
	var nlasms_arr = [];
...
def evaluate_const_in_function(func : @nlasm::function_t, module : ptd::sim(), math_fs : @post_processing::math_funs_t, 
...
def set_interpreted_changed_functions(state : @post_processing::state_t, math_fs : @post_processing::math_funs_t, ref 
...
def get_called_switched(fun_calls : @post_processing::fun_tree_t, switched : @post_processing::math_funs_t) : 
	@post_processing::math_funs_t {
	var called = {};
...
def get_switched_func(old : @post_processing::math_funs_t, new : @post_processing::math_funs_t) : 
	@post_processing::math_funs_t {
	var ret = {};
...
def set_non_math_fun_rec(ref math_fs : @post_processing::math_funs_t, key : ptd::sim(), called_in : ptd::hash(ptd::hash(
		ptd::sim()))) {
...
def set_mathfun_in_modules(ref state : @post_processing::state_t, math_fs : @post_processing::math_funs_t, ref 
...
def set_const_reg(ref blocks : @flow_graph::blocks_t, math_fs : @post_processing::math_funs_t, mod_name : ptd::sim(), 
	reg_size) {
	var regs = [];
	rep var i (reg_size) {
...
def evaluate_const_in_blocks(ref blocks : @flow_graph::blocks_t, math_fs : @post_processing::math_funs_t, func : 
...
def set_const_block(number : ptd::sim(), ref blocks : @flow_graph::blocks_t, math_fs : @post_processing::math_funs_t, 
	ref state : @post_processing::const_reg_t, mod_name : ptd::sim(), regs : ptd::arr(@post_processing::reg_const)) {
...
def evaluate_const(func : @nlasm::function_t, module : ptd::sim(), ins_nr : ptd::sim(), ref const : 
	@post_processing::reg_val_const, ref registers : ptd::arr(@post_processing::reg_val_const), state : 
...
def push_load_const(ref cmds : ptd::arr(@nlasm::cmd_t), const : @post_processing::reg_val_const, dest : ptd::sim(), 
	old_cmd : @nlasm::cmd_t) {
...
def set_const_block_val(number : ptd::sim(), blocks : @flow_graph::blocks_t, ref new_blocks : @flow_graph::blocks_t, 
	math_fs : @post_processing::math_funs_t, ref state : @post_processing::const_reg_val_t, interpreter_state : 
	@interpreter::state_t, regs : ptd::arr(@post_processing::reg_val_const), func : @nlasm::function_t, module : 
		ptd::sim()) {
	var block = blocks[number];
	if (state[number]->was > 0) {
		var diff = false;
